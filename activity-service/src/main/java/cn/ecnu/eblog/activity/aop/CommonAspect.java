package cn.ecnu.eblog.activity.aop;
...
public class CommonAspect {
    ...
    @Pointcut("execution(* cn.ecnu.eblog.activity.controller.*.*(..))")
    private void execTime() {
    }
    @Pointcut("execution(* cn.ecnu.eblog.activity.controller.*.*(..)) && @annotation(cn.ecnu.eblog.common.annotation.Inner)")
