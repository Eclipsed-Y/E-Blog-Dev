package cn.ecnu.eblog.statistic.aop;
...
public class CommonAspect {
    ...
    @Pointcut("execution(* cn.ecnu.eblog.statistic.controller.*.*(..))")
    private void execTime() {
    }
    @Pointcut("execution(* cn.ecnu.eblog.statistic.controller.*.*(..)) && @annotation(cn.ecnu.eblog.common.annotation.Inner)")
